...
[Working Application - Deployed](https://OnRoads-app.netlify.app/)

- OnRoads-html - working html/css/javascript project (contains assets)
...
```sh
npx create-react-app@latest OnRoads-app
```
...
// JSX
;<img src={logo} className='nav-logo' alt='OnRoads' />
```
